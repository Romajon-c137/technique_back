...
urlpatterns = [
    ...
    path('api/v1/technique/', include('equipment.urls')),
    path('api/v1/maintenance/', include('maintenance.urls')),
    path('api/v1/notifications', include('notifications.urls')),
    
    # Banners — explicit paths
    path('api/v1/banners', banner_list,   name='banner-list'),
    path('api/v1/banners/<int:pk>', banner_detail, name='banner-detail'),
